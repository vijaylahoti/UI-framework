...
public class TaxesPageObjects extends TestActions {
	WebDriver  driver;
	Logger log = Logger.getLogger(ChargeTypePageObjects.class);
	public TaxesPageObjects (WebDriver  driver) {
		super(driver);
		this.driver=driver;
	...
	@FindBy(xpath="//a[@href='/admin/tax/tax-table']")
	public WebElement taxes_Card;
	...
	//
	@FindBy(xpath="(//span[text()='Taxes'])[1]")
	public WebElement taxesLinkOnBreadcrumb;
	
	@FindBy(xpath="//span[text()='Taxes Details']//parent::div")
	public WebElement taxesdetails_text;

	@FindBy(xpath="//span[text()='Taxes Create']//parent::div")
	public WebElement taxesCreate_text;
	
	@FindBy(xpath="//span[text()='Taxes']//parent::div")
	public WebElement taxes_text;
	
	@FindBy(xpath="//span[text()='Taxes Update']//parent::a")
	public WebElement taxes_update_text;
	
	@FindBy(id="name")
	public WebElement tax_Name;

	@FindBy(xpath="(//div[@class='ant-select-selection__rendered'])[2]")
	public WebElement taxType_dropdown;
	
	@FindBy(xpath="//li[text()='GST'] ")
	public WebElement taxType_GST;
	...
	@FindBy(id="taxPercentage")
	public WebElement taxPercentage;
	
	@FindBy(xpath="(//div[@class='ant-select-selection__rendered'])[5]")
	public WebElement taxSubtypes_dropdown;
	
	@FindBy(xpath="(//li[text()='CGST '])[1]")
	public WebElement taxSubtypes_CGST;
	
	@FindBy(id="description")
	public WebElement taxDescription;
	
	@FindBy(id="name[name]")
	public WebElement taxesNameOnFilterPage;
	
	
	public void navigateToAdminCardPageFromTaxesPage() {
		this.click(master_Module);
		this.click(taxes_Card);
		this.click(masterLinkOnBreadcrumb);
	}

	public void navigateToAdminCardPageFromTaxesCreatePage() {
		this.click(taxes_Card);
		this.click(createNew);
		this.click(masterLinkOnBreadcrumb);
	}
	
	public void navigateToAdminCardPageFromTaxesDetailsPage() throws InterruptedException {
		this.click(taxes_Card);
		Thread.sleep(2000);
		this.click(viewIcon);
	...
	public void navigateToAdminCardPageFromTaxesUpdatePage() throws InterruptedException {
		this.click(taxes_Card);
		Thread.sleep(2000);
		this.click(editIcon);
		this.click(acceptAlert);	
	...
	public void navigateToTaxesPageFromTaxesCreatePage() {
		this.click(taxes_Card);
		this.click(createNew);
		this.click(taxesLinkOnBreadcrumb);
	}
	
	public void navigateToTaxesPageFromTaxesDetailsPage() throws InterruptedException {
		Thread.sleep(2000);
		this.click(viewIcon);
		this.click(acceptAlert);	
		this.click(taxesLinkOnBreadcrumb);
	...
	public void navigateToTaxesPageFromTaxesUpdatePage() throws InterruptedException {
		Thread.sleep(2000);
		this.click(editIcon);
		this.click(acceptAlert);	
		this.click(taxesLinkOnBreadcrumb);
	...
	public void downloadTaxesDetailsInEXCEL()  {
		this.click(exportAs);
		this.click(excel);
		this.click(excelgeneratedSuccessfully_Message);
	}
	
	public void downloadTaxesDetailsInCSV() throws InterruptedException {
		this.click(exportAs);
		this.click(csv);
	...
	public void viewTaxes() throws InterruptedException{
		Thread.sleep(3000);
		//this.waitForEle(viewIcon);
		this.click(viewIcon);
		this.click(acceptAlert);	
	}
	public  void editTaxes(String code) throws InterruptedException{
		Thread.sleep(2000);
		//this.waitForEle(editIcon);
		this.click(editIcon);
		this.click(acceptAlert);
		tax_Name.click();
		tax_Name.clear();
	    this.sendkeys(tax_Name,code);
		this.click(update_button);
		this.click(updatedSuccessfully_Message);
		
}
	public void filterTaxes(String name) {
		this.click(filter_button);
		this.sendkeys(taxesNameOnFilterPage, name);
		this.click(okFilter);
	...
	public void clickOnTaxTypeLinkOnBreadcrumb() {
		this.click(taxesLinkOnBreadcrumb);
	}
	...
	public String isTaxesLinkTextDisplayed() {
		String TaxesLinkText=taxesLinkOnBreadcrumb.getText();
		return TaxesLinkText;
	}

	public String isTaxesDetailsTextDisplayed() {
		String TaxesDetailsText=taxesdetails_text.getText();
		return TaxesDetailsText;
	}

	public String isTaxesTextDispleyed() {
		String TaxesText=taxes_text.getText();
		return TaxesText;
	}
	public String isTaxesCreateTextDispleyed() {
		String TaxesCreateText=taxesCreate_text.getText();
		return TaxesCreateText;
	}
	public String isTaxesUpdateTextDisplayed() {
		//this.waitForEle(airline_update_text);
		String 	TaxesUpdateText= taxes_update_text.getText();
		return TaxesUpdateText;
	}
	
	public void createTaxes(String name, String percentage,String description ) {
		this.sendkeys(tax_Name, name);
		this.click(taxType_dropdown);
		this.click(taxType_GST);
		this.click(country_dropdown);
		this.click(country_India);
		this.sendkeys(taxPercentage,percentage);
		this.click(taxSubtypes_dropdown);
		this.click(taxSubtypes_CGST);
		this.sendkeys(taxDescription, description);
